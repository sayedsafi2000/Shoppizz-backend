...
//database connection with mongodb compus
mongoose.connect("mongodb+srv://sayedsafidev:safi102030@cluster0.yu8st.mongodb.net/e-commerce");
...
//Creting API For deleting product
...
//creating api from getting api
app.get("/allproducts", async (req, res) => {
    let products = await Product.find({});
    console.log("All pro fetched");
    res.send(products)
})
